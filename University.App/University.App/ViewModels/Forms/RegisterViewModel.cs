    ...
    public class RegisterViewModel : BaseViewModel
    {
        ...
        async void Register()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(this.Email) || string.IsNullOrEmpty(this.Password) || string.IsNullOrEmpty(this.Confirm_Password))
                {
                    this.IsRunning = false;
                    this.IsEnabled = true;
                ...
                this.IsRunning = false;
                this.IsEnabled = true;
                //this.Email = this.Confirm_Password = this.Password = string.Empty;
            }
            catch (Exception ex)
            {
                this.IsRunning = false;
